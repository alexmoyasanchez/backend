...
public class GameManagerImpl implements GameManager {
    ...
    public void addInsignia(String username, String nameInsignia, String avatar){
        Usuario usuario = getUser(username);
        Insignias insignia = new Insignias(nameInsignia, avatar);
        usuario.addInsignia(insignia);
